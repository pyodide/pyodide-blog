...
wheels that we do not include in our distribution. We added support for Rust
packages and made major progress in supporting CMake packages. We also added 34
new packages including a large number of popular packages, for example bitarray,
...
released it as a custom package. This can help people to test dedicated Pyodide
applications. For general purpose Python packages, it is probably better 
