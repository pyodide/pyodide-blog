...
known as [pygame-web](https://github.com/pygame-web). If your Python application
relies solely on pygame-ce, pygame-web might provide better performance, while
if you need an environment that supports a wide range of packages, including
pygame-ce, you can use Pyodide.

We would like to thank the pygame-ce maintainers, especially to Paul m. p. peny
(@pmp-p), for helping us integrate pygame-ce into Pyodide.
