...
As part of this effort, we worked on defining [the Pyodide ABI](https://pyodide.org/en/stable/development/abi.html). This should help
...
we will also be allowed to upload Pyodide packages, i.e., with the
...
From the users' perspective, accessing packages not included in the Pyodide
...
the new [patched version](https://github.com/matplotlib/matplotlib/pull/29568) of
...
core developer and JupyterLite maintainer, who is now maintaining this new
backend.
...
A special note of thanks to Ian Thomas for his work on the new Matplotlib backend.
